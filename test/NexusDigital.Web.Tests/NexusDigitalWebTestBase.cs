...
using NexusDigital.Models.TokenAuth;
...
public abstract class NexusDigitalWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static NexusDigitalWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(NexusDigitalWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<NexusDigitalDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<NexusDigitalDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<NexusDigitalDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<NexusDigitalDbContext, Task<T>> func)
    {
        T result;
